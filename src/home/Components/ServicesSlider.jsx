...
const ServicesSlider = forwardRef((props, ref) => {
  ...
  const services = [
    {
      ...
      description: "We partner with the best hotels to provide comfortable accommodations at competitive prices, ensuring quality stays without breaking your budget.",
      icon: (
    ...
    },
    {
      id: 2,
      title: "Food & Drinks",
      description: "Experience local cuisine with our curated dining options, from street food tours to fine dining experiences, all included in your package.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: 3,
      title: "Safety Guide",
      description: "Your safety is our priority. Our experienced guides provide detailed safety briefings and are trained in first aid and emergency procedures for every destination.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Enjoy hassle-free travel with our private transportation services available 24/7, from airport transfers to daily excursions with professional drivers.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "We create custom travel itineraries based on your interests, whether you're seeking adventure, relaxation, cultural experiences, or a mix of everything.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Our dedicated support team is available around the clock to assist with any questions or concerns during your travels, providing peace of mind wherever you go.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="services-section py-16 px-6 bg-white" ref={ref}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Our Services</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            We offer a comprehensive range of travel services to make your journey comfortable, 
